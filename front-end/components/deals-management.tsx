...
import { useAuth, ROLE_SALES_AGENT as SALES_AGENT_ROLE_ID, ROLE_RECEPTION as RECEPTION_ROLE_ID } from "@/lib/auth" // Import useAuth and numeric role constants
  ...
  return (
    <div className="space-y-6">
            ...
            <div className="flex items-center justify-between">
              ...
              {(hasRole(RECEPTION_ROLE_ID) || hasRole(SALES_AGENT_ROLE_ID)) && (
          ...
          <TableBody>
            {filteredDeals.length === 0 ? (
              ...
              filteredDeals.map((deal) => {
                const canEditDelete = hasRole(RECEPTION_ROLE_ID) || (user && deal.created_by && deal.created_by.Int64 === user.id);
                return (
